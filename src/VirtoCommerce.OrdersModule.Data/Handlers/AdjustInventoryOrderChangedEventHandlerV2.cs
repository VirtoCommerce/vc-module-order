...
namespace VirtoCommerce.OrdersModule.Data.Handlers
{
    ...
    /// </summary>
    public class AdjustInventoryOrderChangedEventHandlerV2 : IEventHandler<OrderChangedEvent>
    {
        private readonly ISettingsManager _settingsManager;
        private readonly ICrudService<Store> _storeService;
        private readonly IItemService _itemService;
        private readonly IReservationService _reservationService;
        private readonly ILogger<AdjustInventoryOrderChangedEventHandlerV2> _logger;
        ...
        public AdjustInventoryOrderChangedEventHandlerV2(
            ICrudService<Store> storeService,
            ISettingsManager settingsManager,
            IItemService itemService,
            IReservationService reservationService,
            ILogger<AdjustInventoryOrderChangedEventHandlerV2> logger)
        {
