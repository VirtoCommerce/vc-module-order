...
angular.module(moduleName, ['virtoCommerce.catalogModule', 'virtoCommerce.pricingModule', 'virtoCommerce.customerModule', 'virtoCommerce.storeModule'])
    ...
    // check permissions to read price
    ...
    .run(
        ['$rootScope', '$http', '$compile', 'platformWebApp.mainMenuService', 'platformWebApp.widgetService', 'platformWebApp.bladeNavigationService', '$state', '$localStorage', 'virtoCommerce.orderModule.order_res_customerOrders',
            'platformWebApp.permissionScopeResolver', 'virtoCommerce.storeModule.stores', 'virtoCommerce.orderModule.knownOperations', 'virtoCommerce.orderModule.knownLimitResponseScopes', 'virtoCommerce.orderModule.hasPermissionsToReadPrices',
