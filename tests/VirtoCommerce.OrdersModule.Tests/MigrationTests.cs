...
public class MigrationTests
{
    ...
    {
        DateTime after = new DateTime(2025, 1, 1);

        var mySqlMigrations = GetMigrationTypes(typeof(VirtoCommerce.OrdersModule.Data.MySql.MySqlDataAssemblyMarker).Assembly, after);
        var postgreMigrations = GetMigrationTypes(typeof(VirtoCommerce.OrdersModule.Data.PostgreSql.PostgreSqlDataAssemblyMarker).Assembly, after);
        var sqlServerMigrations = GetMigrationTypes(typeof(VirtoCommerce.OrdersModule.Data.SqlServer.SqlServerDataAssemblyMarker).Assembly, after);
