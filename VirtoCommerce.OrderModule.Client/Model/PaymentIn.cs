...
namespace VirtoCommerce.OrderModule.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PaymentIn :  IEquatable<PaymentIn>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PaymentIn);
        }

        /// <summary>
        /// Returns true if PaymentIn instances are equal
        /// </summary>
        /// <param name="other">Instance of PaymentIn to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentIn other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
