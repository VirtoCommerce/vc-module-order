...
namespace VirtoCommerce.OrderModule.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BankCardInfo :  IEquatable<BankCardInfo>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as BankCardInfo);
        }

        /// <summary>
        /// Returns true if BankCardInfo instances are equal
        /// </summary>
        /// <param name="other">Instance of BankCardInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BankCardInfo other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
