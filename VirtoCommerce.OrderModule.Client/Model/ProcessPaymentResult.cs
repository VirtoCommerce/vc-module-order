...
namespace VirtoCommerce.OrderModule.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ProcessPaymentResult :  IEquatable<ProcessPaymentResult>
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProcessPaymentResult {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ProcessPaymentResult);
        }

        /// <summary>
        /// Returns true if ProcessPaymentResult instances are equal
        /// </summary>
        /// <param name="other">Instance of ProcessPaymentResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProcessPaymentResult other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
