...
namespace VirtoCommerce.OrderModule.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CustomerOrder :  IEquatable<CustomerOrder>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CustomerOrder);
        }

        /// <summary>
        /// Returns true if CustomerOrder instances are equal
        /// </summary>
        /// <param name="other">Instance of CustomerOrder to be compared</param>
        /// <returns>Boolean</returns>
