...
namespace VirtoCommerce.OrderModule.Client.Model
{
    /// <summary>
    /// DashboardStatisticsResult
    /// </summary>
    [DataContract]
    public partial class DashboardStatisticsResult :  IEquatable<DashboardStatisticsResult>
    {
        /// <summary>
        ...
        public List<Money> Revenue { get; set; }

        /// <summary>
        /// Gets or Sets RevenuePeriodDetails
        /// </summary>
        [DataMember(Name="revenuePeriodDetails", EmitDefaultValue=false)]
        public List<QuarterPeriodMoney> RevenuePeriodDetails { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DashboardStatisticsResult {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as DashboardStatisticsResult);
        }

        /// <summary>
        /// Returns true if DashboardStatisticsResult instances are equal
        /// </summary>
        /// <param name="other">Instance of DashboardStatisticsResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DashboardStatisticsResult other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
